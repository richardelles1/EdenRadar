...
export const cornellScraper: InstitutionScraper = {
  ...
  async scrape(): Promise<ScrapedListing[]> {
    try {
      ...
      const urls = [
        "https://www.research.cornell.edu/tech-transfer/available-technologies",
        "https://technology.cornell.edu/available-technologies/",
        "https://ctt.cornell.edu/technologies/",
      ];
