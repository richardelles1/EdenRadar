 ...
 *
 * Deliberately excludes "platform technology" and "platform" — delivery/
 * manufacturing platforms derive biology from their payload/indication via the
 * TIER1/TIER2 indication-text rules and should NOT be short-circuited here.
 ...
 * Deliberately excludes "nanoparticle" — same reason as platform.
 */
