    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{ height: "50px", background: `${SCOUT_CARD_TINTS.research.stripColor}0d`, borderBottom: `1px solid ${SCOUT_CARD_TINTS.research.stripColor}26` }}
        />
        ...
        <div className="absolute inset-0 z-[4] flex flex-col gap-1.5 pl-4 pr-8 pt-[56px] pb-3">
          ...
          {/* Source / journal — always visible; falls back to generic type label */}
          <p className={`text-[11px] font-semibold truncate ${config.badgeClass.split(" ").filter(c => c.startsWith("text-")).join(" ")}`}>
            {journalName ?? config.label}
          </p>
