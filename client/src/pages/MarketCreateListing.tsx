            ...
            <div className="rounded-xl border border-card-border bg-card p-6 space-y-5">
              ...
              <div className="rounded-lg border border-border p-4 space-y-3">
                <div className="flex items-start justify-between gap-3">
                  <div>
                    <p className="text-sm font-semibold text-foreground">Confidentiality — choose what to hide</p>
                        ...
                        <div className="flex items-center justify-between gap-3 rounded-md border border-border/60 bg-background/40 px-3 py-2">
                          ...
                          <FormControl>
                            <Switch
                              ...
                              data-testid={`create-listing-blind-${opt.key}`}
                            />
                          </FormControl>
                        </div>
                      </FormItem>
              ...
              <div className="rounded-lg border border-indigo-500/20 bg-indigo-500/5 p-4 space-y-2">
                ...
                {anyBlind ? (
                  ...
                  <p className="text-sm font-semibold text-foreground" data-testid="preview-asset-name">{previewAssetName || "(no asset name set)"}</p>
                )}
                <div className="text-[11px] text-muted-foreground space-y-1 pt-1">
                  ...
                  {linkedAsset && (
                    <p><span className="font-medium text-foreground">Institution (Eden panel):</span> {blindFields.institution ? <em>Confidential — revealed after NDA</em> : (linkedAsset.institution || "—")}</p>
                  )}
                </div>
              </div>
