...
const FULL_CONVERSATION: ChatMessage[] = [
  {
    role: "eden",
    text: "Good morning. Since your last session, I've indexed 47 new programs across 22 institutions. Highest signal this week: CNS preclinical and ADC platforms. Three programs have exclusivity windows closing within 90 days.",
    delay: 0,
    instant: true,
  },
  {
    role: "user",
    text: "Start with oncology. What's worth a look at Hopkins this week?",
    delay: 4500,
  },
  {
    role: "eden",
    text: "14 JHU oncology programs indexed. The HDAC inhibitor overlaps with Pfizer's recent Seagen integration territory — likely a dead end for most buyers. The CAR-T is different. That PI has two prior licensings at this exact stage, both closed above $40M upfront. I'd start there.",
    delay: 6500,
    scanning: true,
  ...
  {
    role: "user",
    text: "The CAR-T looks strong. What does the licensing window look like?",
    delay: 16000,
  },
  {
    role: "eden",
    text: "90-day exclusivity window, opened last Tuesday. No LOIs on file as of this morning. The institution has run two prior exclusive deals with top-10 pharma — they move quickly. If your team wants to engage, this week is the right time.",
    delay: 18400,
    typingFor: 2000,
  },
  {
    role: "user",
    text: "Let's widen the search. What preclinical CNS assets are looking strong across all institutions?",
    delay: 25000,
  },
  {
    role: "eden",
    text: "Strong cluster at Mayo, Stanford, and Columbia. Mayo's alpha-synuclein program leads at 93 — the PI closed two prior licensings at preclinical stage. Columbia's ALS program stands out: exclusivity window closes in 60 days, no LOIs on file. That one may be worth a call this week.",
    delay: 27000,
    scanning: true,
  ...
  {
    role: "user",
    text: "We also need ADC platforms open for exclusive licensing. IND-enabling stage, ideally.",
    delay: 37000,
  },
  {
    role: "eden",
    text: "Fourteen ADCs match. MIT HER2 leads at 92. The linker chemistry is covered by a separate patent, but both assets fall under a single exclusive license term sheet — so you're acquiring the full stack. I've removed the three programs that only offer non-exclusive terms.",
    delay: 39000,
    scanning: true,
    assetCards: DEMO_ASSETS_ADC,
  },
  {
    role: "user",
    text: "Add the MIT HER2, Mayo alpha-syn, and Hopkins CAR-T to our pipeline watch list.",
    delay: 49000,
  },
  {
    role: "eden",
    text: "Done. All three are in your pipeline. You'll get real-time alerts if any change stage, publish new data, or receive an LOI from another party. Want me to pull the supporting literature for the MIT program?",
    delay: 51500,
    typingFor: 2000,
  },
  {
    role: "user",
    text: "Yes — and flag anything that scores 90-plus in gene therapy this month.",
    delay: 57500,
  },
  {
    role: "eden",
    text: "Gene therapy filter is live. You'll hear from me the moment something crosses 90. First literature package for the MIT HER2 program will be in your inbox within the hour.",
    delay: 60000,
    typingFor: 1800,
  },
];
