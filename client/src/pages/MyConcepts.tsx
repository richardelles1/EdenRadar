...
import {
  ...
  Users, DollarSign, GraduationCap, ChevronDown, ChevronUp, Mail,
} from "lucide-react";
            ...
            return (
              <div key={c.id} data-testid={`card-my-concept-${c.id}`}>
                <Link href={`/discovery/concept/${c.id}`}>
                  <div className="group p-5 rounded-xl border border-border bg-card hover:border-amber-500/40 hover:shadow-md transition-all duration-200 cursor-pointer">
