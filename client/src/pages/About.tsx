  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="relative z-10 flex-1">
        ...
        {/* Hero */}
        <section
          className="relative overflow-hidden flex flex-col items-center justify-center text-center px-4 sm:px-6"
          style={{ minHeight: "78vh" }}
        >
          <RadarBackground />
          <div className="relative z-10 max-w-screen-xl mx-auto w-full pt-24 pb-20">
        ...
        {/* Bottom CTA */}
        <section
          className="relative overflow-hidden px-4 sm:px-6 py-24 text-center"
          style={{
            background: "linear-gradient(135deg, hsl(25 80% 6%) 0%, hsl(33 75% 9%) 60%, hsl(38 70% 7%) 100%)",
            borderTop: "1px solid hsl(33 85% 44% / 0.25)",
          }}
        >
          <div className="relative z-10 max-w-2xl mx-auto">
            <h2 className="text-3xl sm:text-4xl font-bold mb-5 leading-tight" style={{ color: "hsl(38 25% 91%)" }}>
              The discovery gap is a solvable problem.
            </h2>
            <p className="text-base mb-10 max-w-md mx-auto" style={{ color: "hsl(38 15% 62%)" }}>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                ...
                style={{ background: "hsl(38 25% 91%)", color: "hsl(25 80% 12%)" }}
              >
                Get Started
                <ArrowRight className="w-4 h-4 ml-2" />
              </Button>
              <Button
                ...
                style={{
                  ...
                  border: "1px solid hsl(33 85% 44% / 0.3)",
                  color: "hsl(33 60% 68%)",
                }}
              >
                See Pricing
      ...
      <footer className="relative z-10 py-8 px-4 sm:px-6 text-xs" style={{ background: "hsl(25 80% 6%)", borderTop: "1px solid hsl(33 85% 44% / 0.15)", color: "hsl(38 10% 45%)" }}>
