...
export default function IndustryProfile() {
  ...
  return (
    <div className="p-6 max-w-xl mx-auto">
      ...
      <div className="mt-6 rounded-xl border border-card-border bg-card p-4 flex items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          <Bell className="w-4 h-4 text-muted-foreground shrink-0" />
          <div>
            <p className="text-sm font-medium text-foreground">Notification preferences</p>
            <p className="text-xs text-muted-foreground mt-0.5">
              Alert frequency and delivery settings are managed in Settings.
            </p>
          </div>
        </div>
