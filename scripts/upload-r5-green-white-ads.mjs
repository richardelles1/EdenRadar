#!/usr/bin/env node
// Upload round-5 green-and-white ads to Google Drive at
//   EdenRadar/Ads/green-white-round-5-2026-05/
// After upload, verifies the destination folder file count via the Drive
// API and exits non-zero if the expected count is not met.
...
async function main() {
  ...
  const expectedTotal = localNames.length;
  console.log(`Local: ${expectedTotal} files (${expectedPng} PNGs + manifest)`);
